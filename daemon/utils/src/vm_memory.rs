...
pub fn create_guest_memory(
    ...
    // }
    // warn!("pxg create_guest_memory {:?} regions at vm_memory.rs", mmap_regions.len());
    // let mut file = File::create("/mnt/pmem0/foo.txt").unwrap();
    // write!(file, "pxg create_guest_memory {:?} regions at vm_memory.rs", mmap_regions.len()).unwrap();
